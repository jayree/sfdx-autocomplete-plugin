...
_See code: [src/commands/autocomplete/index.ts](https://github.com/jayree/sfdx-autocomplete-plugin/blob/v1.1.2/src/commands/autocomplete/index.ts)_
<!-- commandsstop -->
