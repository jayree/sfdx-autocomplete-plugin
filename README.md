...
_See code: [src/commands/autocomplete/index.ts](https://github.com/jayree/sfdx-autocomplete-plugin/blob/v2.0.3/src/commands/autocomplete/index.ts)_
<!-- commandsstop -->
