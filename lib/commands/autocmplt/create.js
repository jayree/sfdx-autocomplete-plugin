...
SFDX_AC_BASH_COMPFUNC_PATH=${path.join(new URL('./', import.meta.url).pathname, '..', '..', '..', 'autocomplete', 'bash', 'sfdx.bash')} && test -f $SFDX_AC_BASH_COMPFUNC_PATH && source $SFDX_AC_BASH_COMPFUNC_PATH;
`;
    }
    get zshSetupScript() {
