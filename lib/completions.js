...
export class CompletionLookup {
    constructor(name, topicSeparator = ' ') {
        ...
        this.CompletionMapping = {
            targetusername: _a.targetUserNameCompletion,
            'target-org': _a.targetUserNameCompletion,
            targetdevhubusername: _a.targetUserNameCompletion,
            'target-hub-org': _a.targetUserNameCompletion,
            instanceurl: this.topicSeparator === ' '
                ? _a.instanceurlCompletion
                : _a.instanceurlCompletionColon,
...
_a = CompletionLookup;
CompletionLookup.targetUserNameCompletion = {
